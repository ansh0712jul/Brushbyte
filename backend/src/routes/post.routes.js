...
import { addCommentOnPost, addnewPost,  bookMarkPost,  deletePost,  getAllComments, getAllPosts, getLoggedInUserPosts, likeorDislikePost } from "../controllers/post.controller.js";
...
router.route("/book-mark-post/:postId").patch(verifyJwt , bookMarkPost)
